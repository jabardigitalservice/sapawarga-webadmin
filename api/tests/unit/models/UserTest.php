    ...
    public function testValidateUserFields()
    {
        ...
        $this->specify(
            ...
            function () {
                ...
                $this->assertTrue($user->hasErrors($this->username));
                $this->assertTrue($user->hasErrors($this->email));
        ...
        $this->specify(
            ...
            function () {
                ...
                $this->assertFalse($user->validate($this->username));

                // Set username length as 5
                $user->username = 'abcde';
                // Verify that validation must be failed
                $this->assertTrue($user->validate($this->username));
        ...
        $this->specify('email username must be less than 255 characters', function () {
            ...
            $user->email = 'test@example.com';
            $this->assertTrue($user->validate($this->email));
            ...
            $this->assertFalse($user->validate($this->email));
        });
