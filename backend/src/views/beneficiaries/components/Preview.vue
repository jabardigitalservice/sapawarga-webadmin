  ...
  <div v-loading="loading" class="app-container">
    <el-row v-if="beneficiaries">
      ...
      <el-col class="side-col" :sm="24" :md="8" :lg="8">
        ...
        <div class="preview-content">
          <p>{{ $t('label.beneficiaries-domicile-kabkota') }}</p>
          <p class="content">{{ beneficiaries.domicile_kabkota_name ? beneficiaries.domicile_kabkota_name : '-' }}</p>
        </div>
        <div class="preview-content">
          <p>{{ $t('label.beneficiaries-domicile-kecamatan') }}</p>
          <p class="content">{{ beneficiaries.domicile_kec_name ? beneficiaries.domicile_kec_name : '-' }}</p>
        </div>
        <div class="preview-content">
          <p>{{ $t('label.beneficiaries-domicile-kelurahan') }}</p>
          <p class="content">{{ beneficiaries.domicile_kel_name ? beneficiaries.domicile_kel_name : '-' }}</p>
        </div>
        <div class="preview-content">
          <p>{{ $t('label.beneficiaries-rw') }}</p>
