  ...
  <div class="app-container">
    <el-row :gutter="10">
      <el-col :sm="24" :lg="8" :xl="6">
        ...
        <vue-friendly-iframe :src="urlMap" :style="{'border':0}" @load="onLoad" @document-load="onDocumentLoad" />
      </el-col>
  ...
  methods: {
    getDetail() {
      fetchRecord(this.id).then(response => {
        const { name, address, description, category, seq, kabkota_id, phone_numbers, latitude, longitude, cover_image_path
        // kec_id, kel_id,
        } = response.data
