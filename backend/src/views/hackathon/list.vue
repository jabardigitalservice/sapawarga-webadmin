    ...
    <el-row :gutter="20">
      <el-col :lg="24">
        ...
        <el-table v-loading="listLoading" :data="list" border stripe fit highlight-current-row style="width; 100%" @sort-change="changeSort">
          ...
          <el-table-column prop="title" sortable="custom" label="Judul Laporan" min-width="225" />

          <el-table-column prop="name" sortable="custom" label="Nama Pelapor" min-width="225" />

          <el-table-column prop="category" sortable="custom" label="Kategori" align="center" min-width="150" />
          ...
          <el-table-column prop="status" label="Actions" align="center" width="120">
