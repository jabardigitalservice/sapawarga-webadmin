...
export function fetchRecordGetPKH(id) {
  /* return request({
    url: `/beneficiaries/allocation/${id}`,
    method: 'get'
  }) */
  return new Promise(resolve => {
    resolve({ 'success': true, 'status': 200, 'data': { 'id': 1219522, 'id_bdt': 12121, 'jenis_bantuan': 'PKH', 'nik': '3201120903810009', 'no_kk': '3201120', 'name': ' \tINDRA MAHMUDI', 'province_bps_id': '32', 'kabkota_bps_id': '3271', 'kec_bps_id': '3271060', 'kel_bps_id': '3271060002', 'province_id': null, 'kabkota_id': null, 'kec_id': null, 'kel_id': null, 'province': { 'id': 1, 'code_bps': '32', 'name': 'JAWA BARAT' }, 'kabkota': { 'id': 20, 'code_bps': '3271', 'name': 'KOTA BOGOR' }, 'kecamatan': { 'id': 417, 'code_bps': '3271060', 'name': 'TANAH SAREAL' }, 'kelurahan': { 'id': 6002, 'code_bps': '3271060002', 'name': 'KEDUNG JAYA' }, 'rt': '1', 'rw': '2', 'address': 'CIMANGGU GANG H. ENUNG NO. 55', 'domicile_province_bps_id': '32', 'domicile_kabkota_bps_id': '3271', 'domicile_kec_bps_id': '3271060', 'domicile_kel_bps_id': null, 'domicile_kabkota_name': { 'code_bps': '3271', 'name': 'KOTA BOGOR' }, 'domicile_kec_name': { 'code_bps': '3271060', 'name': 'TANAH SAREAL' }, 'domicile_kel_name': null, 'domicile_rt': '7', 'domicile_rw': '2', 'domicile_address': 'CIMANGGU GANG H. ENUNG NO. 55 RT 001 RW 002', 'phone': 'No Hp. 0895604499917 RT', 'total_family_members': 0, 'job_type_id': 21, 'job_status_id': null, 'job_type_name': { 'id': 21, 'title': 'Lainnya', 'seq': 99 }, 'job_status_name': null, 'income_before': 0, 'income_after': 0, 'image_ktp': null, 'image_kk': null, 'image_ktp_url': null, 'image_kk_url': null, 'is_need_help': null, 'is_poor_new': null, 'notes': null, 'notes_approved': null, 'notes_rejected': null, 'status_verification': 1, 'status_verification_label': 'Belum Terverifikasi', 'status': 10, 'status_label': 'Aktif', 'created_at': 1587402491, 'updated_at': 1587402491, 'created_by': 2 }})
  })
}
